...
interface IOriginSerivceFactory {
...
interface I_DEFAULT_PLAYER_OPTIONS {
    videoBuffer: number;
...
type IBridgePlayerConfig = Partial<IBridgePlayerConfig>;

type IplayerConfig = Partial<IplayerConfig>;


type IRTCPlayerConfig = Partial<IRTCPlayerConfig>;

type IWavePlayerConfig = Partial<IWavePlayerConfig>;
type IWavePlayerExtend = Partial<IWavePlayerExtend>;
...
interface IAduioContextPlayerConfig {
    sampleRate?: number;
