...
const VideoComponents: React.FC<IVideoComponent> = (props) => {
  ...
  useEffect(() => {
    ...
    let { url, showAudio = false, hasAudio = false, hasVideo = true, useOffScreen = false, audioDrawType = 1, fftsize, updataBufferPerSecond, renderPerSecond, bufferSize, degree, streamType, isLive, fileData } = props;
