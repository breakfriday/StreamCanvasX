...
const VideoComponents = (props) => {
  ...
  useEffect(() => {
    let { url, showAudio = false, hasAudio = false, hasVideo = true, useOffScreen = false, audioDrawType } = props;
    ...
    let player = createPlayerServiceInstance({ url, contentEl: containerRef.current!, showAudio, hasAudio, hasVideo, errorUrl: data_img, useOffScreen, audioDraw: audioDrawType });
