...
declare class SPSParser {
    ...
    static getProfileString(profile_idc: any): "Unknown" | "Baseline" | "Main" | "Extended" | "High" | "High10" | "High422" | "High444";
    static getLevelString(level_idc: any): string;
    static getChromaFormatString(chroma: any): "4:4:4" | "4:2:2" | "4:2:0" | "Unknown";
}
